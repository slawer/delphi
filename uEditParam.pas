...
uses
  ...
  Dialogs, upf2, uEditParamConst, uDepGrafList1, StdCtrls,
  ExtCtrls, ComCtrls, uAbstrArray, Buttons, uDEPdescript, uShowImageConst,
  uDEPgrafJob1;
...
procedure TEditParam.FormCreate(Sender: TObject);
begin
  inherited;
  self.jUniType := pc003_132_jMain;
  self.Caption  := pc003_132_Caption;
  numChanals    := prqTInteger.Create;
  borders       := prqTBorders.Create;
end;

procedure TEditParam.Init(jobParam: TDEPgrafJob1; Intervals: prqTGrafInterval; gWind: TprqRptGrafWindow);
var
  pg: TprqRptGraf1;
  jC1: Integer;
begin
...
//  fjobParam.Tag := 0;
  ...
  self.RadioGroup1.Height := (self.RadioGroup1.Items.Count * pc003_132_001) + pc003_132_002;
...
procedure TEditParam.RadioGroup1Click(Sender: TObject);
begin
  inherited;
  setChoiseValue2;
end;

procedure TEditParam.setChoiseValue2;
begin
...
procedure TEditParam.FormClose(Sender: TObject; var Action: TCloseAction);
begin
  inherited;
  numChanals.Free;
  borders.Free;
...
procedure TEditParam.findNearest(numChanal: Integer);
var
  pg: TprqRptGraf1;
  num: Integer;
...
function TEditParam.FindGrafOnEtaps(dTime: Double; pg: TprqRptGraf1): Integer;
var
  jC1: Integer;
  rcd: rcdTcontainer;
begin
...
function TEditParam.FindFistPoint(dTime: Double): Integer;
var
  jC1: Integer;
  dT: Double;
begin
...
function TEditParam.FindLastPoint(dTime: Double): Integer;
var
  jC1: Integer;
  dT: Double;
begin
...
procedure TEditParam.BitBtn2Click(Sender: TObject);
begin
  inherited;
  Close;
end;

procedure TEditParam.BitBtn1Click(Sender: TObject);
var
  j1: Integer;
begin
  inherited;
...
//  fjobParam.Tag := 1;
  ...
  uSupport.SendMessageToParent(self.taskParam, self.jUniKeySelf,
                               pc003_132_AcceptMsg, 0, 0, 0, true, j1)

end;

procedure TEditParam.Metod1_1(const noise: Double);
var
  s1: String;
  jC1: Integer;
  p1: TprqRptTX;
...
//  _Metod1_1(noise, self.borders.xVal, self.borders.yTime);
  ...
  s1 := format(pc003_132_021, [self.borders.phNChanal, noise]);
  ShowMessage(s1);
end;

procedure TEditParam.Metod1_2(const noise, par1, par2: Double; b1, b2: Boolean);
var
  s1: String;
  jC1: Integer;
  p1: TprqRptTX;
...
//  _Metod1_2(noise, par1, par2, b1, b2, self.borders.xVal, self.borders.yTime);
  ...
  s1 := format(pc003_132_022, [self.borders.phNChanal, par1, par2, noise]);
  ShowMessage(s1);
end;

procedure TEditParam.Metod1;
var
  s5, s3, s2, s1: String;
  noise: Double;
begin
  ...
  begin
    ...
    begin
      ShowMessage(pc003_132_020);
      Exit;
    end;

    s2 := self.RadioButton1.Caption;
    s1 := format(pc003_132_015,
...
procedure TEditParam.setInterval(bRder: prqTGrafInterval2);
var
  j1: Integer;
begin
  j1 := bRder.b_Index;
...
procedure TEditParam.RestoreParam1(dxVal, dTime: prqTDouble; const noise: Double;
                                    var ParCrnt, TmrCrnt: Double;
                                    const goalParCrnt, goalTmrCrnt: Double);
var
  xn, n, x, a, b: Double;
...
procedure TEditParam.RadioButton4Click(Sender: TObject);
begin
  inherited;
  setChoiseValue3;
end;

procedure TEditParam.setChoiseValue3;
begin
...
procedure TEditParam.RadioButton5Click(Sender: TObject);
begin
  inherited;
  setChoiseValue3;
end;

procedure TEditParam.Metod2;
var
...
begin
  ...
  begin
    ...
    try
      ...
      ShowMessage(pc003_132_018);
      Exit;
    end;

    s2 := self.RadioButton5.Caption;
    s1 := format(pc003_132_016,
                [self.borders.phNChanal,
                 s3,
                 s2,
                 Edit6.Text,
...
procedure TEditParam.Metod2_1(const noise: Double);
var
  s1: String;
  jC1: Integer;
  p1: TprqRptTX;
...
procedure TEditParam.Metod2_2(const noise, par1, par2: Double; b1,
  b2: Boolean);
var
  s1: String;
  jC1: Integer;
...
begin
  ...
  begin
    ...
    try
      ...
      ShowMessage(pc003_132_025);
      Exit;
    end;

    s2 := self.RadioButton8.Caption;
    s1 := format(pc003_132_028,
                [self.borders.phNChanal,
                 s3,
                 s2,
                 Edit9.Text,
...
//  _Metod3_1(self.borders.xVal, self.borders.yTime);
  ...
  s1 := format(pc003_132_031, [self.borders.phNChanal]);
  ShowMessage(s1);
end;

procedure TEditParam.Metod3_2(const noise, par1, par2: Double);
var
  s1: String;
  jC1: Integer;
  p1: TprqRptTX;
...
//  _Metod3_2(noise, par1, par2, self.borders.xVal, self.borders.yTime);
  ...
  s1 := format(pc003_132_030, [self.borders.phNChanal, par1, par2]);
  ShowMessage(s1);
end;

procedure TEditParam.Metod3_3(const noise: Double);
var
  s1: String;
  jC1: Integer;
  p1: TprqRptTX;
...
procedure TEditParam._Metod1_2(const noise, par1, par2: Double; b1,
...
procedure TEditParam._Metod1_1(const noise: Double; _xVal,
  _yTime: prqTDouble);
var
  dxVal, dTime: prqTDouble;
  lastIndex, jC1: Integer;
...
procedure TEditParam._Metod2_1(const noise: Double; _xVal,
  _yTime: prqTDouble);
var
  dxVal, dTime: prqTDouble;
  lastIndex, jC1: Integer;
...
procedure TEditParam._Metod2_2(const noise, par1, par2: Double; b1,
  b2: Boolean; _xVal, _yTime: prqTDouble);
var
  dxVal, dTime: prqTDouble;
  jC1: Integer;
...
procedure TEditParam._Metod3_1(_xVal, _yTime: prqTDouble);
var
...
procedure TEditParam._Metod3_2(const noise, par1, par2: Double; _xVal,
  _yTime: prqTDouble);
var
  jL1, jL2, jC1: Integer;
  brd1, brd2: prqTGrafInterval2;
...
procedure TEditParam._Metod3_3(const noise: Double; _xVal,
  _yTime: prqTDouble);
var
  jL1, jL2, jC1: Integer;
  brd1, brd2: prqTGrafInterval2;
