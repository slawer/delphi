...
uses
  ...
  Buttons, ExtCtrls{, uRaportKst1data};

type
  TOreolBegTuneBtn2 = class(Tpf2)
    Panel1: TPanel;
    Panel2: TPanel;
    BitBtn1: TBitBtn;
    BitBtn2: TBitBtn;
...
procedure TOreolBegTuneBtn2.FormCreate(Sender: TObject);
begin
  jUniType   := pc003_119_jMain;
  Caption    := pc003_119_Caption;
end;

procedure TOreolBegTuneBtn2.BitBtn1Click(Sender: TObject);
begin
  bSaveParam := True;
  Close;
end;

procedure TOreolBegTuneBtn2.BitBtn2Click(Sender: TObject);
begin
  Close;
end;

procedure TOreolBegTuneBtn2.FormActivate(Sender: TObject);
begin
  if bFirst then
  begin
...
procedure TOreolBegTuneBtn2.FormClose(Sender: TObject;
...
function TOreolBegTuneBtn2.getParamNW(var bAuto, bNotQ: Boolean;
...
procedure TOreolBegTuneBtn2.BitBtn3Click(Sender: TObject);
begin
  inherited;
